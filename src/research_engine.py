...
Quan trọng: trường "script_outline" phải là LỜI THOẠI thực sự sẽ đọc lên bằng TTS — viết liên tục như người đang nói, KHÔNG dùng nhãn cấu trúc như "Hook:", "Nội dung:", "CTA:", "Main points:" hay bất kỳ markdown nào.
...
[
  {{
    ...
    "script_outline": "Toàn bộ lời thoại sẽ đọc lên (TTS-ready, KHÔNG có nhãn 'Hook:', 'CTA:' v.v., viết liên tục như người đang nói)",
